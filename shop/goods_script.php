...
if (!$smarty->is_cached($tpl, $cache_id))
{
    ...
    $smarty->assign('goods_list', $goods_items);
            ...
            {
                $smarty->assign('goods_css', 'best');
            }elseif ($_GET['intro_type'] == 'is_new') {
                $smarty->assign('goods_css', 'new');
            }elseif ($_GET['intro_type'] == 'is_hot') {
                $smarty->assign('goods_css', 'hot');
            }elseif ($_GET['intro_type'] == 'is_promote') {
                $smarty->assign('goods_css', 'promote');
            }elseif ($_GET['intro_type'] == 'is_random') {
                $smarty->assign('goods_css', 'random');
            }
